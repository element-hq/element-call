...
| **Analytics consent**                        | Element Call will show a consent UI.                                                                                              | Element Call will not sure a consent UI. The messenger app should only provide the embedded Element Call with the [analytics URL parameters](./url-params.md#embedded-only-parameters) if consent has been granted. |
